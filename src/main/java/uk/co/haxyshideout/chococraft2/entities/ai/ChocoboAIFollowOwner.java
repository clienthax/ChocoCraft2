...
public class ChocoboAIFollowOwner extends EntityAIBase
{
	...
	{
		EntityLivingBase entitylivingbase = this.chocobo.getOwnerEntity();

		if (entitylivingbase == null)
		{
			return false;
		}
		else if (this.chocobo.getMovementType() != EntityChocobo.MovementType.FOLLOWOWNER)
		{
			return false;
		}
		else if (this.chocobo.getDistanceSqToEntity(entitylivingbase) < (double)(this.minDist * this.minDist))
		{
			return false;
		}
		else
	...
	{
		return !this.petPathfinder.noPath() && this.chocobo.getDistanceSqToEntity(this.theOwner) > (double)(this.maxDist * this.maxDist) && chocobo.getMovementType() == EntityChocobo.MovementType.FOLLOWOWNER;
	}
