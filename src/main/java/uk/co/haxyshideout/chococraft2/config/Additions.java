...
public class Additions
{
	...
	public static final ArmorMaterial chocoDisguiseMaterial = EnumHelper.addArmorMaterial("chocoDisguise", Constants.MODID + ":chocoDisguise", 200, new int[] { 3, 7, 6, 3 }, 10, SoundEvents.item_armor_equip_generic);
	...
	public static void registerAdditions()
	{
		...
		chocoboLegRawItem = new GenericItemFood(4, 0.3F, true).setPotionEffect(new PotionEffect(Potion.getPotionById(PotionType.getID(PotionTypes.poison)), 30, 0), 0.3F).setUnlocalizedName("chocoboLegRawItem")
